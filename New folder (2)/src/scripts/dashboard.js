...
$("#first_supervisors_supervisee").children().attr("draggable","true");
$("#second-supervisors-supervisee").children().attr("draggable","true");
 var draggingElementParent;
function dragOver(){
    event.preventDefault();
    console.log("dragOverTrigerd");
...
function dragStart(){
    ...
    draggingElementParent="#"+$("#"+event.target.id).parents(".list-scroll").prop("id");
...
$(document).ready(function(){
	var superviseesOfSupervisor1 = $("#first-supervisors-supervisees").children();
	var superviseesOfSupervisor2 = $("#second-supervisors-supervisees").children();
    $(document).on("dragover","#first-supervisors-supervisees,#second-supervisors-supervisees",dragOver);
    $(document).on("drop","#first-supervisors-supervisees,#second-supervisors-supervisees",drop);
    superviseesOfSupervisor1.each(function(){
    	var currentObject = this;
    	$(currentObject.id).on("dragstart",dragStart);
